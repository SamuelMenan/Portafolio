  ...
  return (
    <section className={`py-12 ${mobile ? "py-8" : ""}`}>
      ...
      <div className="flex items-center gap-4 mb-8">
        <span className="text-xs tracking-widest uppercase font-bold">06 — Contact</span>
      ...
      <div className={`grid gap-8 ${mobile ? "grid-cols-1" : "grid-cols-[1fr_1fr]"}`}>
        ...
        <div className="flex flex-col gap-4">
          <div className="border-2 border-black p-4">
            <p className="text-xs font-bold uppercase tracking-widest mb-4 border-b border-black pb-2">Contact Info</p>
            <div className="flex flex-col gap-3 text-sm">
              ...
              <div className="border border-gray-300 px-3 py-2 flex justify-between items-center">
                ...
                <span className="font-bold text-xs">github.com/SamuelMena</span>
              </div>
              <div className="border border-gray-300 px-3 py-2 flex justify-between items-center">
        ...
        {/* Right: Simple form */}
        <div className="border-2 border-black p-4">
          <p className="text-xs font-bold uppercase tracking-widest mb-4 border-b border-black pb-2">Send a Message</p>
          <div className="flex flex-col gap-3">
            <div>
              <p className="text-xs text-gray-500 mb-1 uppercase tracking-widest">Name</p>
            ...
            <div>
              <p className="text-xs text-gray-500 mb-1 uppercase tracking-widest">Message</p>
      ...
      <div className="mt-12 border-t-2 border-black pt-4 flex items-center justify-between text-xs text-gray-500">
        <span>Samuel Esteban Mena Pupiales — Portfolio</span>
        <span>© 2025</span>
      </div>
    </section>
  )
