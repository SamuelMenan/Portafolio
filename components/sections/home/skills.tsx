...
const skillGroups: SkillGroup[] = [
  {
    ...
    items: [
      ...
      { es: 'Next.js', en: 'Next.js', icon: SiNextdotjs, color: '#000000' },
  ...
  },
  {
    ...
    items: [
      ...
      { es: 'Express.js', en: 'Express.js', icon: SiExpress, color: '#000000' },
      { es: 'Django', en: 'Django', icon: SiDjango, color: '#092E20' },
      { es: 'Python', en: 'Python', icon: SiPython, color: '#3776AB' },
  ...
  },
  {
    ...
    items: [
      ...
      { es: 'GitHub Actions', en: 'GitHub Actions', icon: SiGithubactions, color: '#2088FF' },
...
export default function SkillsSection({ mobile, lang }: Props) {
  return (
